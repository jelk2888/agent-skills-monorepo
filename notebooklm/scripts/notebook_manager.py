        ...
        if self.library_file.exists():
            try:
                with open(self.library_file, 'r') as f:
                    ...
                    print(f"[OK] Loaded library with {len(self.notebooks)} notebooks")
    ...
    if args.command == 'add':
        ...
        if notebooks:
            ...
            for notebook in notebooks:
                ...
                print(f"\n  [BOOK] {notebook['name']}{active}")
                print(f"     ID: {notebook['id']}")
                print(f"     Topics: {', '.join(notebook['topics'])}")
                print(f"     Uses: {notebook['use_count']}")
        else:
            print("[INFO] Library is empty. Add notebooks with: notebook_manager.py add")
        ...
        if results:
            ...
            for notebook in results:
                print(f"\n  [BOOK] {notebook['name']} ({notebook['id']})")
